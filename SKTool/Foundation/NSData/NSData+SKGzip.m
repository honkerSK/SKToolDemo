...
#import "NSData+SKGzip.h"
#import <zlib.h>
#import <dlfcn.h>

@implementation NSData (SKGzip)

static void *sk_libzOpen() {
    static void *libz;
...
{
    if (self.length == 0 || [self sk_isGzippedData])
    {
        return self;
    }
    
    void *libz = sk_libzOpen();
...
{
    return [self sk_gzippedDataWithCompressionLevel:-1.0f];
}
