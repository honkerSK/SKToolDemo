...
#import "NSString+SKEmoji.h"

@implementation NSString (SKEmoji)


static NSDictionary * sk_s_unicodeToCheatCodes = nil;
static NSDictionary * sk_s_cheatCodesToUnicode = nil;

+ (void)sk_initializeEmojiCheatCodes
{
    ...
    @synchronized(self) {
        sk_s_unicodeToCheatCodes = forwardMap;
        sk_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)sk_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!sk_s_cheatCodesToUnicode) {
        [NSString sk_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [sk_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)sk_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    if (self.length) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [sk_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
