...
#import "NSString+SKScore.h"

@implementation NSString (SKScore)

- (CGFloat)sk_scoreAgainst:(NSString *)otherString{
    return [self sk_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)sk_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self sk_scoreAgainst:otherString fuzziness:fuzziness options:NSStringSKScoreOptionNone];
}

- (CGFloat)sk_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringSKScoreOption)options{
    ...
    if(NSStringSKScoreOptionFavorSmallerWords == (options & NSStringSKScoreOptionFavorSmallerWords)){
    ...
    if(NSStringSKScoreOptionReducedLongStringPenalty == (options & NSStringSKScoreOptionReducedLongStringPenalty)){
