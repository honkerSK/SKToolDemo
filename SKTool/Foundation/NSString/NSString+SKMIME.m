...
#import "NSString+SKMIME.h"

@implementation NSString (SKMIME)
...
- (NSString *)sk_MIMEType {
    return [[self class] sk_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)sk_MIMETypeForExtension:(NSString *)extension {
    return [[self sk_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @summary  常见MIME集合
 *
